...
function mouseClicked(){
	...
	let a2 = a + (windowWidth*0.04);
	let a3 = a + (windowWidth*0.09);
	// let a4 = a - (windowWidth*0.005);
	let b = (windowWidth * 0.6);
	let b2 = b - (windowWidth*0.12);
	let b3 = b - (windowWidth*0.07);
	let b4 = b - (windowWidth*0.01);
